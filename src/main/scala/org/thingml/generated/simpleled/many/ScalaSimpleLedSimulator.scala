...
//Companion object
  ...
  case class SoftTimerStateMachine(keepHistory : Boolean, root : Component) extends StateAction {
    ...
    override def onEntry() = {
      println("SoftTimer.onEntry")
//No entry action defined for this state
    }

    override def onExit() = {
      println("SoftTimer.onExit")
//No exit action defined for this state
    }

    val t_self_1295612727 = new InternalTransition(getBehavior, new InternalTransition1295612727(), List((SoftTimer.timerPort.getName, SoftTimer.timerPort.in.timer_start)))
    val t_self_1653382171 = new InternalTransition(getBehavior, new InternalTransition1653382171(), List((SoftTimer.timerPort.getName, SoftTimer.timerPort.in.timer_cancel)))
    case class InternalTransition1295612727 extends InternalTransitionAction {
      ...
      override def executeActions() = {
        println("t_self_1295612727.executeActions")
        start(getEvent(SoftTimer.timerPort.in.timer_start, SoftTimer.timerPort.getName).get.asInstanceOf[Timer_start].delay)
      }

    }
    case class InternalTransition1653382171 extends InternalTransitionAction {
      override def executeActions() = {
        println("t_self_1653382171.executeActions")
        cancel()
      }
...
//create sub-states
    ...
    case class DefaultState extends StateAction {
      override def onEntry() = {
        println("default.onEntry")
//No entry action defined for this state
      }

      override def onExit() = {
        println("default.onExit")
//No exit action defined for this state
      }
...
//Companion object
  ...
  case class LedImplStateMachine(keepHistory : Boolean, root : Component) extends StateAction {
    ...
    val parent : StateMachine = new StateMachine(this, keepHistory, root)
    override def onEntry() = {
      println("LedImpl.onEntry")
//No entry action defined for this state
    }

    override def onExit() = {
      println("LedImpl.onExit")
//No exit action defined for this state
    }
...
//create transitions among sub-states
    val t_LedOff2LedOn_1975209490 = new Transition(LedOff_state, LedOn_state, new TransitionLedOff2LedOn_1975209490(), List((Led.LedPort.getName, Led.LedPort.in.led_on), (Led.LedPort.getName, Led.LedPort.in.led_toggle)))
    parent.addTransition(t_LedOff2LedOn_1975209490)
    val t_LedOn2LedOff_1078635941 = new Transition(LedOn_state, LedOff_state, new TransitionLedOn2LedOff_1078635941(), List((Led.LedPort.getName, Led.LedPort.in.led_off), (Led.LedPort.getName, Led.LedPort.in.led_toggle)))
    parent.addTransition(t_LedOn2LedOff_1078635941)
    case class TransitionLedOff2LedOn_1975209490 extends TransitionAction {
      override def executeActions() = {
        println("t_LedOff2LedOn_1975209490.executeActions")
//No action defined for this transition
      }

    }
    case class TransitionLedOn2LedOff_1078635941 extends TransitionAction {
      override def executeActions() = {
        println("t_LedOn2LedOff_1078635941.executeActions")
//No action defined for this transition
      }
...
//Companion object
  ...
  case class BehaviorStateMachine(keepHistory : Boolean, root : Component) extends StateAction {
    ...
    val parent : StateMachine = new StateMachine(this, keepHistory, root)
    override def onEntry() = {
      println("behavior.onEntry")
      register()
    }

    override def onExit() = {
      println("behavior.onExit")
//No exit action defined for this state
    }

    val t_self_483083644 = new InternalTransition(getBehavior, new InternalTransition483083644(), List((Button.SensorPort.getName, Button.SensorPort.in.update)))
    case class InternalTransition483083644 extends InternalTransitionAction {
      override def executeActions() = {
        println("t_self_483083644.executeActions")
...
//create sub-states
    ...
    case class ReadyState extends StateAction {
      override def onEntry() = {
        println("Ready.onEntry")
//No entry action defined for this state
      }

      override def onExit() = {
        println("Ready.onExit")
//No exit action defined for this state
      }
...
//Companion object
  ...
  case class SimpleLedImplStateMachine(keepHistory : Boolean, root : Component) extends StateAction {
    ...
    val parent : StateMachine = new StateMachine(this, keepHistory, root)
    override def onEntry() = {
      println("SimpleLedImpl.onEntry")
//No entry action defined for this state
    }

    override def onExit() = {
      println("SimpleLedImpl.onExit")
//No exit action defined for this state
    }
...
//create transitions among sub-states
    val t_Idle2Running_987964686 = new Transition(Idle_state, Running_state, new TransitionIdle2Running_987964686(), List((SimpleLed.ButtonPort.getName, SimpleLed.ButtonPort.in.released)))
    parent.addTransition(t_Idle2Running_987964686)
    val t_Running2Running_1218947517 = new Transition(Running_state, Running_state, new TransitionRunning2Running_1218947517(), List((SimpleLed.TimerPort.getName, SimpleLed.TimerPort.in.timer_timeout)))
    parent.addTransition(t_Running2Running_1218947517)
    val t_Running2Idle_11908659 = new Transition(Running_state, Idle_state, new TransitionRunning2Idle_11908659(), List((SimpleLed.ButtonPort.getName, SimpleLed.ButtonPort.in.released)))
    parent.addTransition(t_Running2Idle_11908659)
    case class TransitionIdle2Running_987964686 extends TransitionAction {
      override def executeActions() = {
        println("t_Idle2Running_987964686.executeActions")
//No action defined for this transition
      }

    }
    case class TransitionRunning2Running_1218947517 extends TransitionAction {
      override def executeActions() = {
        println("t_Running2Running_1218947517.executeActions")
    ...
    case class TransitionRunning2Idle_11908659 extends TransitionAction {
      override def executeActions() = {
        println("t_Running2Idle_11908659.executeActions")
        handler.getPort("Timer") match{
...
//create transitions among sub-states
      val t_Idle2Running_1002055195 = new Transition(Idle_state, Running_state, new TransitionIdle2Running_1002055195(), List((SimpleLed.ButtonPort.getName, SimpleLed.ButtonPort.in.pressed)))
      parent.addTransition(t_Idle2Running_1002055195)
      val t_Running2Running_90207697 = new Transition(Running_state, Running_state, new TransitionRunning2Running_90207697(), List((SimpleLed.Timer2Port.getName, SimpleLed.Timer2Port.in.timer_timeout)))
      parent.addTransition(t_Running2Running_90207697)
      val t_Running2Idle_1467264132 = new Transition(Running_state, Idle_state, new TransitionRunning2Idle_1467264132(), List((SimpleLed.ButtonPort.getName, SimpleLed.ButtonPort.in.pressed)))
      parent.addTransition(t_Running2Idle_1467264132)
      case class TransitionIdle2Running_1002055195 extends TransitionAction {
        override def executeActions() = {
          println("t_Idle2Running_1002055195.executeActions")
//No action defined for this transition
        }

      }
      case class TransitionRunning2Running_90207697 extends TransitionAction {
        override def executeActions() = {
          println("t_Running2Running_90207697.executeActions")
      ...
      case class TransitionRunning2Idle_1467264132 extends TransitionAction {
        override def executeActions() = {
          println("t_Running2Idle_1467264132.executeActions")
          handler.getPort("Timer2") match{
            case Some(p) => p.send(new Timer_cancel())
            case None => println("Warning: no port Timer2 You may consider revising your ThingML model.")
          }
